...
# ── CONFIGURE THESE ──────────────────────────────────────────
WEIGHTS    = 'runs/detect/runs/train/bce_run/weights/best.pt'  # path to your trained weights
VIDEO_IN   = 'test/val_20190925_183946_1_1_visible.mp4'                        # input video path
VIDEO_OUT  = 'test/val_20190925_183946_1_1_visible_output_annotated.mp4'                  # output video path
CONF_THRES = 0.25                                    # confidence threshold
IOU_THRES  = 0.45                                    # NMS IoU threshold
IMG_SIZE   = 640                                     # must match training size
CLASSES    = ['helicopter', 'airplane', 'uav']       # your class names
# ─────────────────────────────────────────────────────────────

# Colors per class (BGR): uav=red, helicopter=green, airplane=blue
...
def run_inference_on_video(weights, video_in, video_out):
    ...
    # Warmup — prevents first-frame latency from skewing FPS measurements
    print("Warming up...")
    for _ in range(10):
    ...
    while True:
        ...
        # Draw detections manually for full control over appearance
